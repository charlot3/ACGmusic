    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar sidebar-default" style="padding-bottom: 3%">
            <ul class="nav nav-sidebar" style="padding-left: 20px">推荐
                ...
                <li class="active"><a href="SongList.jsp">推荐歌单</a></li>
            </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="row">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="LatestMusic.jsp">最新音乐</a></li>
            ...
            <div class="col-md-2 col-md-offset-5">
                <ul class="pagination pagination-sm">
                    <li class="active"><a href="LatestMusic.jsp">新歌速递</a></li>
                    <li><a href="LatestDisc.jsp">新碟上架</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <table class="table table-hover table-striped">
                    <tr>
                        <td style="width: 10%;"><a href="#"><img src="src/image/gaara.jpg" class="songlistImage"></a>
                        </td>
                        <td style="width: 30%">SongName</td>
                        <td style="width: 20%"><a href="#">Singer</a></td>
                        <td style="width: 30%"><a href="#">SongList</a></td>
                        <td style="width: 10%">Length(00:00)</td>
                    </tr>
                    <tr>
                        <td style="width: 10%;"><a href="#"><img src="src/image/gaara.jpg" class="songlistImage"></a>
                        </td>
